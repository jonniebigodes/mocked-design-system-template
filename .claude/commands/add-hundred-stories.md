...
- If the file $ARGUMENTS.stories.tsx already exists, lookup the ammount of stories inside, and exit if there are already 100 or more stories.
- If the file $ARGUMENTS.stories.tsx already exists, lookup the ammount of stories inside, and if there are less than 100 stories, append new stories until there are 100 stories total. If there are already 100 or more stories.
